...
const romFiles = new Map([
    ["IBM-Logo", "loktar00/IBM Logo.ch8"],
    ["Brix", "loktar00/Brix [Andreas Gustafsson, 1990].ch8"],
    ["Particle", "loktar00/Particle Demo [zeroZshadow, 2008].ch8"],
    ["Zero", "loktar00/Zero Demo [zeroZshadow, 2007].ch8"],
]);
...
selectRom.addEventListener("change", async (event) => {
    const rom = romFiles.has(selectRom.value)
        ...
        : "loktar00/IBM Logo.ch8";

    const data = await fetch(`roms/${rom}`);
