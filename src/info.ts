...
export const roms = new Map([
    ...
    ['Zero',       'roms/loktar00/Zero Demo [zeroZshadow, 2007].ch8'],
    ...
    ['WipeOff',    'roms/aquova/WIPEOFF'],
    ['Test Image', 'roms/aquova/TEST_IMG'],
]);

// key to press -> [chip8 key, index of the key in DOM for highlight]
